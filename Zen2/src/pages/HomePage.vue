  ...
  <main-layout>
    <div class="main">
      <div class="row col-10 m-auto justify-content-around">
        <div class="col-12">
          <h3 class="text-center mt-3">Welcome to ZenLibrary!</h3>
          <hr />
        </div>
      </div>
      <div v-if="loading">
          ...
          <div v-if="!products.length">
            <div class="row col-md-6 justify-content-center m-auto mt-5">
              <div class="col-8">
                ...
                <h5>Do visit again for new books!</h5>
                <small class="row justify-content-end">ZenLibrary Admin Team</small>
              </div>
            </div>
          </div>
          <div v-else>
...
// onBeforeMount(() => {
//   try {
//     // Fetch data from the API and store it in local session storage
//     const resp = axiosClient.get('/api/request')
//     console.log(resp)
//     sessionStorage.setItem('cartData', JSON.stringify(resp.data))
//   } catch (err) {
