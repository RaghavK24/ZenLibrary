...
from application.api import api, UserAPI, SectionAPI, BookAPI, OrderAPI, RequestAPI
hapi = Api(app)
hapi.add_resource(UserAPI, "/api/user", "/api/user/<username>")
hapi.add_resource(SectionAPI, "/api/section", "/api/section/<int:section_id>")
hapi.add_resource(BookAPI, "/api/book", "/api/book/<int:section_id>", "/api/book/<int:section_id>/<int:book_id>")
hapi.add_resource(OrderAPI, "/api/order", "/api/order/<int:id>")
hapi.add_resource(RequestAPI, "/api/request", "/api/request/<int:id>")
